...
def modify_model(model, target_layers=[6, 8, 15, 18, 21]):
    print("\n开始修改模型，添加 CBAM 注意力机制...")
        ...
        if idx < len(model.model.model):
            ...
            if isinstance(layer, C2f):
                ...
                try:
                    ...
                    print(f"  层 {idx}: C2f (ch={c2}) -> C2f_CBAM")
...
def main():
    ...
    config = {
        ...
        'project': 'runs/detect',
        'name': 'face_emotion_CBAM_m_v1'
    }
    
    print("=" * 70)
    print("YOLOv8m - CBAM Attention Enhanced")
    print("=" * 70)
